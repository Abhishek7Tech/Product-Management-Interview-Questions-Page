    ...
    return (
        <footer className="mx-4 md:mx-20 md:pt-6 py-2">
            <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between">
                ...
                <div className="w-10/12 md:w-auto flex flex-col items-center">
                    {windowWidth.current > width && <ul className="grid grid-cols-2 gap-x-20 gap-y-4">
                        <li className="font-normal font-poppins text-xl text-[#ADADAD]">Newsletter</li>
                        <li className="font-normal font-poppins text-xl text-[#ADADAD]">30 Days of PM</li>
                        <li className="font-normal font-poppins text-xl text-[#ADADAD]">Builders Cohort</li>
                        <li className="font-normal font-poppins text-xl text-[#ADADAD]">Transition to PM role</li>
            ...
            <div className="py-1 text-center">
                {windowWidth.current <= width && <small className="font-medium font-poppins text-[#ADADAD] text-base"> 2021 Crework, 2023</small>}
                {windowWidth.current > width && <small className="font-medium font-poppins text-[#ADADAD] text-base"> copyright <span className="text-lg"> &copy; </span> 2024 Crework</small>}
